...
def read_item_code(image_path, column, num_rows):
    ...
    if not is_similar(first_cell_text, 'ITEM CODE', threshold=80):  # 80 is just an example threshold
