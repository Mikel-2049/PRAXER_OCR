...
def read_material_description(image_path, column, num_rows):
    ...
    if not is_similar(first_cell_text, 'MATERIAL DESCRIPTION', threshold=80):  # 80 is just an example threshold
